...
-- Duplicate Pet Button (White Style)
local dupeButton = Instance.new("TextButton", frame)
dupeButton.Text = "Duplicate Pet"
dupeButton.Font = Enum.Font.FredokaOne
dupeButton.TextSize = 16
dupeButton.TextColor3 = Color3.fromRGB(40, 40, 40) -- Dark text
dupeButton.BackgroundColor3 = Color3.fromRGB(255, 255, 255) -- White button
...
-- Instant duplication (no loading)
